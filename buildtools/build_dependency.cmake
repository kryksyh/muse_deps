...
function(_bd_cmake_build srcdir)
    ...
    if(BD_OS STREQUAL "windows" AND BD_ARCH STREQUAL "arm64ec")
        string(APPEND _initial_cache "set(CMAKE_SYSTEM_PROCESSOR \"ARM64EC\" CACHE STRING \"\" FORCE)\n")
        string(APPEND _initial_cache "set(CMAKE_C_FLAGS_INIT \"/arm64EC\" CACHE STRING \"\" FORCE)\n")
        string(APPEND _initial_cache "set(CMAKE_CXX_FLAGS_INIT \"/arm64EC\" CACHE STRING \"\" FORCE)\n")
        string(APPEND _initial_cache "set(CMAKE_EXE_LINKER_FLAGS_INIT \"/MACHINE:ARM64EC\" CACHE STRING \"\" FORCE)\n")
        string(APPEND _initial_cache "set(CMAKE_SHARED_LINKER_FLAGS_INIT \"/MACHINE:ARM64EC\" CACHE STRING \"\" FORCE)\n")
        string(APPEND _initial_cache "set(CMAKE_MODULE_LINKER_FLAGS_INIT \"/MACHINE:ARM64EC\" CACHE STRING \"\" FORCE)\n")
    endif()
